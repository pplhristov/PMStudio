...
namespace PMStudio.Data.Migrations
{
    ...
    [Migration("20201219192712_AddMaintenanceServiceHashSetInVendorDataModel")]
    partial class AddMaintenanceServiceHashSetInVendorDataModel
    {
            ...
            modelBuilder.Entity("PMStudio.Data.Models.Tenant", b =>
                {
                    ...
                    b.HasOne("PMStudio.Data.Models.Property", "Property")
                        .WithOne("Tenant")
                        .HasForeignKey("PMStudio.Data.Models.Tenant", "PropertyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
