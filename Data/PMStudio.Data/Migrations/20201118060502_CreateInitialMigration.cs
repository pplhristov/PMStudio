        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceServices_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeasedOn = table.Column<DateTime>(nullable: false),
                    PropertyId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropertyVendors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropertyVendors_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PropertyVendors_Vendors_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceServices_IsDeleted",
                table: "MaintenanceServices",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceServices_PropertyId",
                table: "MaintenanceServices",
                column: "PropertyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyVendors_PropertyId",
                table: "PropertyVendors",
                column: "PropertyId");

            migrationBuilder.CreateIndex(
                name: "IX_PropertyVendors_VendorId",
                table: "PropertyVendors",
                column: "VendorId");
